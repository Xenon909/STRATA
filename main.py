...
def handle_live_session():
    ...
    print(f"[SUCCESS] Logged {duration:.1f} minutes for '{topic}'.")
...
def handle_time_budget():
    ...
    if choice == '1':
        ...
        try:
            ...
            print("[SUCCESS] Global weekly cap updated.")
        except ValueError:
        ...
        if topic:
            ...
            try:
                # Assuming database.py handles the constraint math and raises an Exception if cap is exceeded
                db.update_topic_minimum(topic, float(new_min))
                print(f"[SUCCESS] Danger Zone for '{topic}' updated.")
...
def main_loop():
    ...
    while True:
        ...
        if choice == '1':
            ...
            print("[!] Unrecognized command. Please enter a valid numerical ID.")
