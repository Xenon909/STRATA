...
def render_radar_chart():
    ...
    fig, ax = plt.subplots(figsize=(7, 7), subplot_kw=dict(polar=True), facecolor='#121212')
    ...
    plt.title("S.T.R.A.T.A. :: Operational Grid", color='#ffffff', fontsize=13, pad=25, fontweight='bold')
    legend = plt.legend(loc='upper right', bbox_to_anchor=(1.25, 1.1), facecolor='#1e1e1e', edgecolor='#444444')
